...
var sliders = function sliders(slides, direction, prev, next) {
  var slideIndex = 1,
      //текущий слайд
  paused = false;
  var items = document.querySelectorAll(slides); //отвечате за перемещение слайдера
  ...
  activateAnimation(); //если мышка наведена на слайд-автопрокрутка отключается
